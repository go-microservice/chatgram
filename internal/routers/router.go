...
import (
	...
	// _ "github.com/go-microservice/ins-api/docs" // docs is generated by Swag CLI, you have to import it.

	"github.com/go-eagle/eagle/pkg/app"
	"github.com/go-eagle/eagle/pkg/middleware"
	"github.com/go-microservice/ins-api/internal/handler"
)
...
func NewRouter() *gin.Engine {
	...
	g.Use(middleware.Auth([]string{"/v1/auth/register", "/v1/auth/login"}))
