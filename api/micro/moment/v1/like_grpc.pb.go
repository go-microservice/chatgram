...
func (c *likeServiceClient) CreateLike(ctx context.Context, in *CreateLikeRequest, opts ...grpc.CallOption) (*CreateLikeReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.micro.moment.v1.LikeService/CreateLike", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *likeServiceClient) UpdateLike(ctx context.Context, in *UpdateLikeRequest, opts ...grpc.CallOption) (*UpdateLikeReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.micro.moment.v1.LikeService/UpdateLike", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *likeServiceClient) DeleteLike(ctx context.Context, in *DeleteLikeRequest, opts ...grpc.CallOption) (*DeleteLikeReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.micro.moment.v1.LikeService/DeleteLike", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *likeServiceClient) ListLike(ctx context.Context, in *ListLikeRequest, opts ...grpc.CallOption) (*ListLikeReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.micro.moment.v1.LikeService/ListLike", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LikeService_CreateLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.micro.moment.v1.LikeService/CreateLike",
	}
...
func _LikeService_UpdateLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.micro.moment.v1.LikeService/UpdateLike",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LikeService_DeleteLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.micro.moment.v1.LikeService/DeleteLike",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LikeService_ListLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.micro.moment.v1.LikeService/ListLike",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
